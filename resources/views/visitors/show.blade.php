                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="fs-5">{{ $visitor->organization ?: 'Not specified' }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="fs-5">{{ $visitor->department }}</p>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="fs-5">
                                @if($visitor->status === 'IN')
                                    <span class="badge badge-status badge-in">Inside</span>
                                @else
                                    <span class="badge badge-status badge-out">Outside</span>
                                @endif
                            </p>
                        </div>
                        ...
                        @if($visitor->check_out_time)
                            <div class="mb-3">
                                <h6 class="text-muted">Duration Inside</h6>
                                <p class="fs-5">{{ $visitor->check_out_time->diffForHumans($visitor->check_in_time) }}</p>
                            </div>
                        @endif
                    </div>
                </div>
